...
public class BaselineWritingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("canvass", "onCreate: Screen info"+width+" "+height+" ");
    ...
    public void Next(View view)
    {
        ...
        width  = Resources.getSystem().getDisplayMetrics().widthPixels;
        height = Resources.getSystem().getDisplayMetrics().heightPixels;
        Log.i("canvass", "onCreate: Canvass info"+width+" "+height+" "+h+ " "+w);
        ...
        if (i == 70)
        {
          /*  Intent intent = new Intent(BaselineWritingActivity.this, WritingView.class);
            ...
            Intent intent = new Intent(BaselineWritingActivity.this, End.class);
            startActivity(intent);
        }
        else {
            i++;
    ...
    public String getCharacter(int i)
    {
        ...
        {
            String dLig[]={"بب", "بج", "بس", "بک", "بل", "بم", "بن", "بط", "بص", "بی", "بع", "بق", "بف", "بہ", "با", "بد", "بر", "بو", "بے", "ٹا","جا", "سا", "کا", "لا", "ما", "نا", "طا", "صا", "یا", "عا", "قا", "فا", "ہا"};
            character=dLig[i-38];
        }
        return character;
